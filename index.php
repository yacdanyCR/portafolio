                ...
                <div class="col-md-4 mt-4">
                    <div class="card  bg-white bg-gradient border-0 rounded" style="width: 18rem;">
                        ...
                        <svg enable-background="new 0 0 1771 2499.8" viewBox="0 0 1771 2499.8" xmlns="http://www.w3.org/2000/svg">
                            <path d="m1387.8 92.5h-146.9l152.8 165.9v78.9h-314.8v-92.4h152.8l-152.8-165.9v-79h309zm-371.4 0h-147.1l153 165.9v78.9h-314.9v-92.4h152.8l-152.8-165.9v-79h309zm-367.8 3.8h-158.5v144.8h158.5v96.3h-271.3v-337.4h271.3z" fill="#131313" />
                            ...
                            <path d="m886.3 845.5v221.7h-535.4l-4.6-49.8-10.1-112.4-5.3-59.5zm-.8 448.6v221.7h-244.1l-4.3-49.8-10.1-112.4-5.3-59.5h263.7z" fill="#ebebeb" />
                        </svg>
                ...
                <div class="col-md-4 mt-4">
                    <div class="card" style="width: 18rem;">
                        <div class="card  bg-white bg-gradient border-0 rounded" style="width: 18rem;">
                            ...
                            <svg style="display:flex;align-self:center;padding-top:50px;" width="2500" height="1309" viewBox="0 0 256 134" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet">
                                <g fill-rule="evenodd">
                ...
                <div class="col-md-6 mt-5 ">
                    ...
                    <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item">
                                <img src="img/proyectos/proyecto_1/Captura de pantalla (3).png" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="img/proyectos/proyecto_1/Captura de pantalla (4).png" class="d-block w-100" alt="...">
                            </div>
                        </div>
